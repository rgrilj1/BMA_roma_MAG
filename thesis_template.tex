...
\caption{Prepoznavanje imenskih entitet}
        \begin{tabular}{l|ccc}
             & {\tt Precision} & {\tt Recall}  & F1   \\ \hline
                        {\tt Hugging Face - Transformers} & 0.949 & 0.953 & 0.951 \\
                        {\tt Google Cloud}   & 0.920 & 0.919  & 0.919  \\
                         {\tt Amazon Web Services}   & \textbf {0.954} & \textbf {0.961}& \textbf {0.958}  \\     
                        {\tt Microsoft Azure}   & 0.858 & 0.824  & 0.840
