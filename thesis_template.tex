...
\section{Analiza sentimenta}
Rezultati iz čankov so bili povzeti iz \cite{sent_clanek}.
...
\begin{tabularx}{1.1\textwidth} { 
 ...
 \hline
  \textbf{Besedilo}  & \textbf{ Imenske entitete}   & \textbf{AWS SageMaker} &  \textbf{Transformers}    \\
 \hline
Ta film je odličen.  &Positive   & Positive  &Positive   \\ 
\hline
  Ta hrana je zanič. &Negative  &Negative    &Negative  \\ 
    \hline
     Nisem siguren kako se počitim ob tem. &Neutral    & Neutral & Neutral \\ 
    \hline
\end{tabularx}
\end{center}
\end{table}
...
Rezultati iz čankov so bili povzeti iz \cite{povz_clanek}.
...
Rezultati iz čankov so bili povzeti iz \cite{pharses_clanek}.
...
Rezultati iz čankov so bili povzeti iz \cite{uvrscanje_clanek}.
...
\hline
Apple je bila ustanovljena leta 1976.    &Novice  &Novice   &Novice        \\ 
    \hline
...
Iz tabele lahko razberemo da so bile narejene napake pri obeh ponudnikih, vendar je Google Vertex AI imel manj napak. 
