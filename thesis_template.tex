...
Text za analizo:
 \begin{figure}[h!]
\begin{center}
\includegraphics[width=10cm]{analiza.png}
\end{center}
\caption{Besedilo za analizo}
\label{pic2}
\end{figure}
...
Rezultat analize:
 \begin{figure}[h!]
\begin{center}
\includegraphics[width=10cm]{rezultat.png}
\end{center}
\caption{Rezultat analize}
\label{pic2}
\end{figure}

V tem kratkem primeru recenzent izraža negativno čustvo, kar kaže na razočaranje nad filmom in kritizira njegovo pomanjkanje izvirnosti. Nizka ocena 4 dodatno odraža negativno mnenje.
