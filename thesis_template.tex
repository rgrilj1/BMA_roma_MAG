...
Pri zazava objektov so najogosteje uporabljeni R-CNN, R-FCN, FPN, in Casecade R-CNN algoritmi\cite{zaznava_clanek}.
...
Pri analizi sentimenta je bil uporabljen  \hyperref[sec:imdb]{\underline {IMDb Reviews}} korpus.
...
Opazimo da sta obe storitvi naredili isto napako pri istem primeru, saj sta zaznali dolgočano kot nevtralno in ne negativno. 
...
\multicolumn{1}{r}{} &   & \textbf{Množica 1}             & \textbf{Množica 2}                & \textbf{Množica 3}               & \textbf{Povprečje}      
                 \\ \hline      \hline                                                                                                                                                                                                                                                                                                                                       
\textbf{Transformers}   & Priklic  & 0.933             & 0.948                  &  0.896             &  \textbf{0.926} (±0.027)                                         \\
...
\bibitem{ključne_clanek} Algorithms to Detect Phrases and Keywords from Text . Dostopno na: \url{https://saturncloud.io/blog/algorithms-to-detect-phrases-and-keywords-from-text/}  [Dostopano10. 06. 2023].
