...
\begin{enumerate}
 ...
 \item Strojno učenje na podlagi besedila: Ta pristop vključuje uporabo algoritmov strojnega učenja, ki so naučeni prepoznati čustveni naboj besed v besedilu na podlagi velikega števila označenih podatkov (besedil s čustvenimi oznakami). Najpogostejši pristop je uporaba algoritmov za klasifikacijo, kot je na primer metoda podpornih vektorjev (SVM) ali nevronske mreže.
 ...
 \item Algoritmi globokega učenja: V zadnjem času so se pojavili tudi pristopi, ki temeljijo na globočem učenju, kot je uporaba rekurentnih nevronskih mrež (RNN) ali transformerskih modelov, ki so pokazali izjemne rezultate pri analizi sentimenta.
\end{enumerate}
