...
\begin{lstlisting}[ basicstyle=\tiny,frame=single]
analytics_client.recognize_entities(besedilo)
    \end{lstlisting}
...
Azure Cognitive Services klic:
\begin{lstlisting}[ basicstyle=\tiny,frame=single]
analytics_client.analyze_sentiment(besedilo)
    \end{lstlisting}
...
Azure Cognitive Services klic:
\begin{lstlisting}[ basicstyle=\tiny,frame=single]
analytics_client.begin_abstract_summary(besedilo)
    \end{lstlisting}
...
Azure Cognitive Services klic:
\begin{lstlisting}[ basicstyle=\tiny,frame=single]
analytics_client.extract_key_phrases(besedilo)
    \end{lstlisting}
...
Azure Cognitive Services klic:
\begin{lstlisting}[ basicstyle=\tiny,frame=single]
analytics_client.begin_multi_label_classify(besedilo)
    \end{lstlisting}
