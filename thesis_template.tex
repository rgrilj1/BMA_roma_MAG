...
Uporabjena je bila metoda “DetectEntities” z dva obveznima parametroma, ki sta “LanguageCode” (jezik besedila) ter “Text” (besedilo na katerem bo narejena analiza), odgovor je vseboval eno ali več zaznanih imenskih entitet ter njegovo lokacijo v stavku 

\textit{Azure:} 

Uporabljena je bila metoda “EntityRecognition” z obveznim parametrom “Text” (besedilo na katerem bo narejena analiza), ter language ki je default “en” (angleški jezik), odgovor je vseboval zaznano kategorijo ter podkategorijo ter  verjetnost. 

\textit{Google:} 

Uporabljena je bila metoda “AnalyzeEntities” kjer imamo dva parametra “Type” (tip vhoda, ki je lahko dokument ali besedilo) ter “Content” (besedilo na katerem bo narejena analiza), kot odgovor pa dobimo več entitet z imenom ter tipom 
