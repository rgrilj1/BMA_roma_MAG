...
Poudarek bo na šestih najpogosteje uporabljenih in razširjenih storitvah na področju obdelave naravnega jezika in obdelave slik. Prvo opisuje prepoznavanje imenskih entitet, katera uporabnikom močno olajša vsakodnevno delo z strankami, saj lahko prepozna imena strnk ter datume v elektronskih sporočilih za lažje sledenje naročilom. Naslednje področje pokriva analizo sentimenta s pomočjo katere uporabniki na družbenih omrežjih lahko ugotovijo, kako se stranke odzivajo na njihove produkte ter s tem prilagajajo svoje produkte glede na rezultate.  Naslednje zelo pomembno področje je povzemanje, ki hitro ustvarja krajše povzetke dolgih poročil in analiz, kar uporabnikom omogoča bolj učinkovito pregledovanje ključnih informacij. Zelo pomembno je tudi prepoznavanje besednih zvez za identifikacijo ključnih pojmov v strateških dokumentih, kar pomaga pri načrtovanju marketinških kompanij in analiz konkurenčnega okolja. Uvrščanje besedil pomaga uporabnikom  pri analizi strankinih mnenj in ocen, kar jim pomaga razumeti, kako se izdelki ali storitve pozicionirajo na trgu v primerjavi z konkurenco. Zadnje področje, ki ga bomo raziskali se na naša na zaznavo objektov, ki jo lahko uporabljamo za nadzor in identifikacijo neželenih oseb ali predmetov na območju objekta, kar prispeva k izboljšani varnosti in nadzoru.

Preverili bomo, katere so najboljše odprtokodne storitve na trgu, izbrali eno izmed najboljših ter naredili primerjavo z najbolj prepoznavnimi oblačnimi ponudniki. Trenutno so na trgu najbolj prepoznavni Google Cloud, Microsoft Azure ter Amazon Web Services.
...
Cilj magistrske naloge je raziskati, kateri ponudnik je najboljši na določenem področju, ter na podlagi analize cenovne ugodnosti, enostavnosti uporabe in uspešnosti določiti, kateri ponudnik se najbolj izplača izbrati.
...
Glavni cilj magistrske naloge bo organizacijam in posameznikom pomagati pri odločitvi, kateri ponudnik obdelave naravnega jezika in slikovnih rešitev je najbolj primeren za njihove specifične potrebe. S tem bomo izvedli poglobljeno analizo in preverili, kako se posamezni ponudniki odrežejo na različnih področjih uporabe naravnega jezika in obdelave slik.

Naš prispevek bo poudaril, kateri ponudnik ponuja najboljšo kombinacijo cenovne ugodnosti, visoke uspešnosti ter enostavne uporabe na izbranih področjih. S tem bomo zagotovili bolj premišljene odločitve in pripomogli k uspešni uporabi teh tehnologij na raznolikih področjih.
%----------------------------------------------------------------
% Poglavje (Chapter) 2
%----------------------------------------------------------------
...
V članku, ki ga je pripravil Marek Hernans in je vključen v literaturo\cite{najboljsi_cloud}, je bila izvedena raziskava stotih najboljših ponudnikov storitev v oblaku, pri čemer je bil poudarek na dejstvu, da trenutno prevladujejo Google Cloud, Microsoft in Amazon Web Services kot vodilni igralci v tem sektorju.

Prav tako je Paulo Gardini Miguel v svojem članku\cite{najboljsi1_cloud}, izvedel analizo 23 najboljših ponudnikov storitev v oblaku, pri čemer je ugotovil, da je najboljši ponudnik Amazon Web Services, Microsoft Azure pa se uvršča na drugo mesto, medtem ko je Google Cloud na tretjem mestu.
...
Področje obdelave naravnega jezika je prvič bilo na voljo leta 2017. Podpora različnim jezikom je pogojena v prvi vrsti z izbiro modela.
...
Hugging Face Transformers \cite{transformers} je odprtokodna knjižnica, ki je postala ena najpomembnejših orodij za obdelavo naravnega  jezika in strojnega učenja. Njen cilj je ponuditi razvijalcem enostaven dostop do najnovejših arhitektur in modelov. Zgrajena je na osnovi programskega jezika Python in je postala ključno orodje za reševanje izzivov na področju obdelave naravnega jezika in razvoja aplikacij ter storitev.

Ena od ključnih prednosti Hugging Face Transformers je enostavnost uporabe. Razvijalci lahko z nekaj vrsticami kode dostopajo do pred-treniranih modelov za takojšno uporabo. Med drugim knjižnica omogoča tudi prilagajanje modelov in ponuja odprtokodno skupnost, ki nenehno prispeva z novimi modeli, izboljšavami in rešitvami.
...
V kontekstu obdelave naravnega jezika se uveljavlja kot močna platforma za razvoj in izvajanje aplikacij. Ponuja storitve, kot je SageMaker, ki omogočajo analizo besedil in razumevanje sentimenta, jezika ter entitet v besedilih. Amazon Transcribe omogoča pretvorbo govora v besedilo, medtem ko Amazon Polly omogoča sintezo besedila v govor. Poleg tega AWS omogoča tudi gradnjo naprednih modelov obdelave naravnega jezika s storitvijo Amazon SageMaker.

Amazon SageMaker je platforma za strojno učenje, ki omogoča razvijalcem in strokovnjakom za podatke gradnjo, usposabljanje in izvajanje modelov strojnega učenja. Z SageMakerjem lahko enostavno ustvarimo modele za različne naloge. Storitev ponuja orodja za obdelavo in analizo besedila, izboljšano prepoznavanje besed in ustvarjanje visoko zmogljivih modelov za aplikacije obdelave naravnega jezika. Poleg tega omogoča avtomatizacijo celotnega cikla strojnega učenja, kar pospešuje razvoj in implementacijo projektov obdelave naravnega jezika v okviru ekosistema. SageMaker je zato ključna komponenta za razvoj naprednih rešitev obdelave naravnega jezika na platformi Amazon Web Services.
...
Azure Cognitive Services so ključni del Azurejevih zmogljivosti za obdelavo naravnega jezika. Te storitve uporabljajo napredne algoritme in modele, ki omogočajo razvoj aplikacij za razumevanje govora, prepoznavo besedila, prevajanje jezikov, analizo sentimenta in druge. 
...
Azure podpira kontejnerizacijo z orodji, kot sta Azure Kubernetes Service in Azure Container Instances, za enostavno upravljanje in orkestracijo kontejnerjev. Za razvojne skupine ponuja Azure DevOps orodja za upravljanje procesov razvoja.
...
Korpus je razdeljen na tri sklope: 
\begin{enumerate}
...
Za analizo obdelave naravnega jezika so bile izbrane tri množice testnih podatkov, vsaka od njih je vsebovala 50 primerov. Razdeljene so bile v tri različne kategorije: novice, finance ter šport. 
...
Za analizo besedila je bila uporabljena funkcija “DetectEntities” z dvema obveznima parametroma, "LanguageCode" (ki določa jezik besedila) in "Text" (besedilo, ki bo analizirano). Odgovor funkcije vsebuje eno ali več zaznanih imenskih entitet ter njihovo lokacijo v stavku.

\textit{Azure:} 

Uporabljena je bila funkcija “EntityRecognition” z obveznim parametrom “Text” (besedilo na katerem bo narejena analiza), ter “Language” (jezik besedila), privzeti jezik je “en” (angleški jezik), odgovor je vseboval zaznano kategorijo ter podkategorijo ter  verjetnost za vsako entiteto. 

\textit{Google:} 
Za analizo entitet je bila uporabljena funkcija ”AnalyzeEntities”, ki zahteva dva parametra: ”Type” (tip vhoda, ki je lahko dokument ali besedilo) ter ”Content” (besedilo, ki bo analizirano). Kot odgovor prejmemo več entitet, vsako z imenom in tipom.
...
Graf prikazuje strošek obdelave testne množice, kjer je potrebno omeniti da smo transformatorje uporabljali na lokalnem okolju, kar pomeni, da stroški uporabe niso nastali. 
...
Analiza je bila izvedena na množici, ki je bila opremljena z označbami pozitivnega, negativnega ali nevtralnega sentimenta.
...
Na podlagi rezultatov iz tabele (glej tabelo Analiza sentimenta) je razvidno, da je najvišjo stopnjo natančnosti dosegel Azure Cognitive Services vendar je bil od drugouvrščenega Google Vertex AI boljši le za 0,4\%. AWS Sagemaker kot tudi Azure Cognitive Services pa sta bila od drugega mesta manj uspešna za 6,2\%.
...
\begin{tabularx}{1.1\textwidth} { 
  ...
  | >{\centering\arraybackslash}X  
    ...
    | >{\centering\arraybackslash}X |}
 \hline
  \textbf{Besedilo}  & \textbf{ Sentiment}   & \textbf{Google Vertex AI  } &  \textbf{Hugging Face Transformers}    \\
 \hline
...
Uporabljena je bila funkcija “AbstractiveSummarization” z parametroma “Language” (jezik besedila), privzeti jezik je “en” (angleški jezik) ter “Text” (besedilo na katerem bo narejena analiza), odgovor je vseboval povzeto besedilo. 
...
Izbrana množica za izvajanje postopkov povzemanja je bila različnih dolžin.
...
\subsection{Analiza napak pri izvlečku besedne zveze} 
Vsi podatki v množici so bili označeni s ključnimi besedami in nato obdelan s pomočjo vsake od navedenih storitev.
...
\label{pic2}
\end{figure}
Iz grafa je razvidno, da je največje število napak zabeleženo pri platformi Google Vertex AI, pri čemer ji takoj sledi Azure Cognitive Services. Platformi Hugging Face Transformers in AWS Sagemaker sta pokazali najmanjše število napak. V tem konkretnem kontekstu se je platforma AWS Sagemaker izkazala kot najboljša, saj je zagotovila najvišjo stopnjo natančnosti pri analizi podatkov.


\textbf{Natančnost} 

Na podlagi rezultatov iz tabele (glej tabelo Prepoznavanje besednih zvez) je razvidno, da je najvišjo stopnjo natančnosti dosegel Google Vertex AI  vendar je bil od drugo uvrščenega Azure Cognitive Services boljši za 4,5\%. AWS Sagemaker je bil od Hugging Face Transformers boljši za 7,9\%.
...
Kot zanimivost lahko omenimo, da je razlika med najboljšim in najslabše uvrščenim rezultatom znašala 9,2 odstotne točke.



\textbf{Hitrost obdelave} 

Google Vertex AI se je izkazal za bolj učinkovitega. Povprečen čas obdelave besedila v okviru Google Vertex AI je znašal 0,2 sekunde, medtem ko je AWS SageMaker za isto nalogo zahteval 0,3 sekunde, Azure Cognitive Services 0,5 sekunde. Hugging Face Transformers pa so za izvajanje na lokalnem okolju potrebovali najdlje in sicer 1s.
...
\textbf{Uporabljene metode za uvrščanje besedila}

\textit{Amazon Web Services:} 

Uporabljena je bila funkcija “ClassifyDocument” z dvema obveznima parametroma, ki sta “LanguageCode” (predstavlja izbran jezik) ter “Text” (podano besedilo, nad katerim je bila izvedena analiza), odgovor je vseboval več zaznanih kategorij ter njihovo verjetnost. 

\textit{Azure:} 

Uporabljena je bila funkcija “AnalyzeText” z dvema obveznima parametroma, ki sta  “Language”  (predstavlja izbran jezik)  ter “Text” (podano besedilo, nad katerim je bila izvedena analiza), odgovor je vseboval več zaznanih kategorij ter njihovo verjetnos.  

\textit{Google:} 
Uporabljena je bila funkcija “ClassifyText ” z dvema obveznima parametroma, ki sta “Type” (tip vhoda, ki je lahko dokument ali besedilo) ter “Content” (besedilo na katerem bo narejena analiza), odgovor je vseboval več zaznanih kategorij ter njihovo verjetnos. 
...
Za potrebe analize smo uporabili množico, pri čemer je vsak primer označen s kategorijo, ki je bila predmet klasifikacije. Vsebina besedil je bila nato obdelana s pomočjo vsake od navedenih storitev.

Število napak je izraženo kot število primerov, kjer je bila kategorija napačno zaznana, glede na skupno število v množici.
