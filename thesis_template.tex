...
\textbf{Analiza sentimenta}                         		 &  Odzivnost  & 0.926              & 0.936                  & 0.891               & 0.981       \\
										   & Natančnost  & 0.928               & 0.924                  & 0.862               & 0.862    \\
                                                                                       & F1 ocena    & \textbf{ 0.929}               & 0.930                  & 0.876               & 0.876      \\            
...
V okviru te magistrske naloge smo se posvetili analizi in primerjavi zmogljivosti treh vodilnih ponudnikov oblačnih storitev v področju obdelave naravnega jezika. Glavni cilj naše raziskave je bil ugotoviti, kateri izmed teh ponudnikov Google, AWS, Azure in Hugging Face izstopa na različnih področjih obdelave naravnega jezika, kot so prepoznavanje imenskih entitet, analiza sentimenta, povzemanje besedil, luščenje ključnih besed, klasifikacija besedila in zaznava objektov.

Iz rezultatov naše raziskave je jasno razvidno, da ima vsak izmed teh ponudnikov svoje edinstvene prednosti in zmogljivosti v različnih področjih obdelave naravnega jezika. AWS se je izkazal kot izjemno učinkovit pri prepoznavanju imenskih entitet, kar je ključno za razumevanje strukture besedil in njihovega konteksta. Hugging Face je prevzel vodilno vlogo pri analizi sentimenta, saj ponuja široko paleto prednatreniranih modelov za natančno določanje čustvenega tona besedil. Azure se je izkazal kot odličen pri povzemanju besedil, kar je ključno za hitro razumevanje vsebine daljših dokumentov.

Prav tako smo ugotovili, da ima vsak ponudnik svoje prednosti v specifičnih nalogah. Azure je izstopal pri luščenju ključnih besed, kar je pomembno za hitro opredelitev glavnih tem v besedilih. Hugging Face je bil izjemno uspešen pri klasifikaciji besedila, kar omogoča avtomatizirano razvrščanje besedil v različne kategorije. AWS pa se je izkazal kot močan v zaznavanju objektov, kar je ključno za obogatitev besedil z vizualnimi elementi.

V prihodnosti se pričakuje še večji napredek v obdelavi naravnega jezika in razvoj novih tehnik ter modelov. S temi spoznanji lahko podjetja in raziskovalci izberejo pravi oblačni ponudnik za svoje specifične naloge v obdelavi naravnega jezika, ob upoštevanju njihovih potreb in zahtev.

V zaključku lahko trdimo, da je vsak izmed izbranih ponudnikov oblačnih storitev Google, AWS, Hugging Face in Azure prinesel svoje inovacije in odličnost na področje obdelave naravnega jezika. Izbor med njimi je odvisen od specifičnih nalog in potreb uporabnikov. V prihodnosti se obeta še večja konkurenčnost in raznolikost rešitev, kar bo prispevalo k še naprednejši in učinkovitejši obdelavi naravnega jezika.
