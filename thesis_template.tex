...
\subsection{Precision}
 Je ena od osnovnih metrik, ki se uporabljajo za ocenjevanje uspešnosti modelov v različnih nalogah, kot je klasifikacija besedila. Natančnost nam pove, kolikšen delež pozitivno napovedanih primerov je dejansko pravilno napovedanih. Metrika se izračuna s formulo:
