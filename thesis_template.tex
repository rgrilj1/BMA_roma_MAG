...
\begin{lstlisting}[ basicstyle=\tiny,frame=single]
text_analytics_client.recognize_entities(besedilo)
    \end{lstlisting}
...
Azure Cognitive Services klic:
\begin{lstlisting}[ basicstyle=\tiny,frame=single]
text_analytics_client.analyze_sentiment(besedilo)
    \end{lstlisting}
...
Azure Cognitive Services klic:
\begin{lstlisting}[ basicstyle=\tiny,frame=single]
text_analytics_client.extract_key_phrases(besedilo)
    \end{lstlisting}
...
text_classification_label_sample(
    project, location, endpoint, besedilo
)
    \end{lstlisting}
