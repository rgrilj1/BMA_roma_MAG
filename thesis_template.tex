...
Uporabjena je bila funkcija “DetectEntities” z dva obveznima parametroma, ki sta “LanguageCode” (jezik besedila) ter “Text” (besedilo na katerem bo narejena analiza), odgovor je vseboval eno ali več zaznanih imenskih entitet ter njegovo lokacijo v stavku 
...
Uporabljena je bila funkcija “AnalyzeEntities” kjer imamo dva parametra “Type” (tip vhoda, ki je lahko dokument ali besedilo) ter “Content” (besedilo na katerem bo narejena analiza), kot odgovor pa dobimo več entitet z imenom ter tipom 
...
Za analizo  smo uporabili nabor podatkov CoNLL-2003, ki vsebuje več kot 200.000 stavkov z označenimi imenskimi entitetami.. Vsako besedilo je bilo obdelano z vsako od navedenih storitev 


\textbf{Natančnost} 

Na podlagi rezultatov iz tabele (glej tabelo Prepoznavanje imenskih entitet) je razvidno, da je najvišjo stopnjo natančnosti dosegel AWS Sagemaker, saj je bil za 3,1\% boljši od drugega uvrščenega Hugging Face Transformers. Google Vertex AI pa je bil le za 0,1\% boljši od drugega uvrščenega modela. Na koncu lestvice pa se je uvrstil Azure Cognitive Services, saj je zaostajal za kar 6,4\% v primerjavi z Google Vertex AI.  
...
Uporabjena je bila funkcija “DetectSentiment” z 2 obveznima parametroma, ki sta “LanguageCode” (predstavlja izbran jezik) ter “Text” (podano besedilo, nad katerim je bila izvedena analiza), odgovor je vseboval zaznan sentiment ter točkovanje kjer pozitiven pomeni več kot 0, negative manj kot 0, nevtralen pa 0.

\textit{Azure:} 

Uporabjena je bila funkcija “SentimentAnalysis”  z parametroma, ki sta “Language” (jezik besedila), privzeti jezik je “en” (angleški jezik) ter “Text” (besedilo na katerem bo narejena analiza), odgovor je vseboval zaznan sentiment ter točkovanje. 

\textit{Google:} 

Uporabjena je bila funkcija “AnalyzeSentiment”  kjer imamo 2 parametra “Type” (tip vhoda, ki je lahko dokument ali besedilo)   ter “Content” (besedilo na katerem bo narejena analiza), kot odgovor pa dobimo več entitet z imenom, tipom entitete ter točkovanje. 
...
Uporabjena je bila funkcija “Summarize”  z  obveznim parametrom, ki je Text (besedilo na katerem bo narejena analiza), odgovor je vseboval povzeto besedilo. 

\textit{Azure:} 

Uporabjena je bila funkcija “AbstractiveSummarization” z parametroma, ki sta “Language” (jezik besedila), privzeti jezik je “en” (angleški jezik) ter “Text” (besedilo na katerem bo narejena analiza), odgovor je vseboval povzeto besedilo. 

\textit{Google:} 
Uporabjena je bila funkcija “SummarizeText” z dvema parametroma “Type” (tip vhoda, ki je lahko dokument ali besedilo) ter “Content” (besedilo na katerem bo narejena analiza), odgovor je vseboval povzeto besedilo. 
...
Uporabjena je bila funkcija “DetectKeyPhrases” z dvema obveznima parametroma, ki sta “LanguageCode” (predstavlja izbran jezik) ter “Text” (podano besedilo, nad katerim je bila izvedena analiza), odgovor je vseboval več zaznanih ključnih besed. 

\textit{Azure:} 

Uporabjena je bila funkcija “KeyPhraseExtraction” z dvema obveznima parametroma, ki sta  “Language”  (predstavlja izbran jezik)  ter “Text” (podano besedilo, nad katerim je bila izvedena analiza), odgovor je vseboval več zaznanih ključnih besed.  

\textit{Google:} 
Uporabjena je bila funkcija “ExtractKeywords” z dvema obveznima parametroma, ki sta “Type” (tip vhoda, ki je lahko dokument ali besedilo) ter “Content” (besedilo na katerem bo narejena analiza), odgovor je vseboval več zaznanih ključnih besed. 
...
Uporabjena je bila funkcija “DetectLabels” z obveznim parametrom, ki je “Image” (slika v formatu base64), odgovor je vseboval zaznane objekte z lokacijskimi okvirji. 

\textit{Azure:} 

Uporabjena je bila funkcija “ImageAnalysis”  z obveznim parametrom “Image” (format ['image/*', 'application/octet-stream']), odgovor je vseboval zaznane objekte z kategorijo ter verjetnostjo za zaznani objekt.

\textit{Google:} 

Uporabjena je bila funkcija “DetectLabels” z obveznim parametrom “Image” (format ['image/*', 'application/octet-stream']), odgovor je vseboval zaznane objekte z kategorijo ter verjetnostjo za zaznani objekt.
