...
\caption{Primer cnn\_dailymail korpusa}
    \begin{center}
        \begin{tabular}{l|ccc}
            label & {\tt text} & {\tt highlights} \\ \hline
                        {\tt 002509a...} &Fears are growing that Britain's jails are becoming... & Athens pushes through... \\
                        {\tt 7526a1...}   & It was a farce that would lead to... &AZ Alkmaar were playing....\\
        \end{tabular}
    \end{center}
\label{tbl:1}
\end{table}
