...
Tukaj je nekaj ključnih značilnosti korpusa SemEval:
\begin{enumerate}
 \item Anotacije: Podatki v SemEval korpusov so običajno anotirani, kar pomeni, da so označeni z dodatnimi informacijami. Na primer, v korpus zbirki za naloge razreševanja sentimenta bi bili vzorci besedil označeni s pozitivnimi, negativnimi ali nevtralnimi sentimenti.
