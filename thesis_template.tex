...
\begin{enumerate}
 ...
 \item Slab slog in gramatika ustvarjeni povzetki, ki so slabo napisani ali vsebujejo napake v slogu in gramatiki, kar je lahko posledica napačnega algoritma. 
  \item Težave z različnimi vrstami objektov: lahko se teže spopadejo z različnimi vrstami objektov, na primer z mahnimi predmeti ali z predmeti, ki so podobni drug drugemu. To lahko privede do napak pri povzemanju objektov.
  \end{enumerate}
