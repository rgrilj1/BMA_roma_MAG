...
Amazon SageMaker ponujaja širok nabor storitev za obdelavo naravnega jezika in sicer: klasifikacija besedila, analiza sentimenta, prepoznavanje imenskih entitet, prevanjanje, povzemanje ter druge. 
...
\textbf{Klasifikacija besedila}                                         &  Priklic  & 0.926                &  0.962                   &  0.763                &  0.920  \\  
...
\section{Povzemanje (Summarisation)}
\begin{table}[h!]
\centering
\caption{Povzetek}
\label{my-label}
...
\section{Prepoznavanje besednih zvez (Key Phrases)}
...
\end{center}
\caption{ Klasifikacija besedila  Ocena F1}
\label{pic2}
\end{figure}
