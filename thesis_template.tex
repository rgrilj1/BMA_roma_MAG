...
\label{pic2}
\end{figure}
Pri analizi imenskih entitet je bil uporabljen CNN/Daily Mail  dataset.
...
Pri izvajanju naloge klasifikacije besedila je bil uporabljen podatkovni niz SemEval-2017.
...
\caption{ Klasifikacija besedila  }
        \begin{tabular}{l|ccc}
             &  Accuracy   \\ \hline
                        {\tt Transformers} & 0.930 & 0.926 & 0.928\\
                        {\tt Vertex AI }   & 0. & 0.  & 0.  \\
                         {\tt AWS SageMaker}   & 0. & 0. & 0. \\     
                        {\tt Azure Cognitive Services}   &  \textbf {0.} & \textbf {0.}  & \textbf {0.}
        \end{tabular}
\label{tbl:1}
\end{table}
...
Pri ustvarjanju povzetka je bil uporabljen dataset CNN/Daily Mail.

Kot najboljša izbira za povzemanje pa se je izkazala storitev Vertex AI ponudnika Google Cloud.
